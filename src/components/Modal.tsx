      ...
      <div className="flex items-center justify-between">
        ...
        <form className="flex flex-col space-y-4">
          <div>
            ...
            <input type="number" id="value1" min="1" max="10" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm md:text-md rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
          </div>
